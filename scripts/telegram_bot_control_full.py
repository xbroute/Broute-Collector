...
purchase-CTA settings, and encrypted multi-destination management while keeping
...
def main() -> int:
    ...
    # Install destinations last so its owner-based authorization overrides the
    # legacy fixed-chat authorization for all previously installed extensions.
